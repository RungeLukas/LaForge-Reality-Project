...
public class OurImageTargets extends Activity implements SampleApplicationControl,
    SampleAppMenuInterface
{
    ...
    // Our renderer:
    private OurImageTargetRenderer mRenderer;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // mDatasetStrings.add("Unser_Target.xml"); //kr: removed because not necessary
        mDatasetStrings.add("Galerie.xml");
    ...
    private void loadTextures()
    {
        ...
        mTextures.add(Texture.loadTextureFromApk("ImageTargets/Buildings.jpeg",
            getAssets()));
        mTextures.add(Texture.loadTextureFromApk("TestOverlay3.png", getAssets()));
    }
    ...
    private void initApplicationAR()
    {
        ...
        mRenderer = new OurImageTargetRenderer(this, vuforiaAppSession);
    ...
    private void setSampleAppMenuSettings()
    {
        ...
        //SMS Änderung
        group.addRadioItem("SMS Target", mStartDatasetsIndex + 2, false);
        group.addRadioItem("SMS Galerie", mStartDatasetsIndex + 3, false);
        Log.d("SMSgruppe", "Anzahl Datasets = " + mDatasetsNumber);
